# AI Agent Workflows & Reference

Detailed guidance for AI coding agents working on the Helm project.
...
1. Read `AGENTS.md` at repo root first (primary source of truth).
2. Read the `docs/codebase-explanation/` files listed in AGENTS.md for the area you're working on.
3. Use the files in this directory for workflow detail, agent definitions, and project-specific patterns.
