            ...
            "nodes": [
                {
                    ...
                    "type": "trigger",
                    "position": {"x": 250, "y": 0},
                    "data": {"label": "Daily at 9am", "triggerType": "onSchedule", "config": {"cron": "0 9 * * *"}},
                },
                {
                    "id": "action-1",
                    "type": "action",
                    "position": {"x": 250, "y": 150},
                    "data": {"label": "Fetch Today's Events", "action": "fetch_calendar_events", "params": {"range": "today"}},
                },
                {
                    "id": "action-2",
                    "type": "action",
                    "position": {"x": 250, "y": 300},
                    "data": {"label": "Send Summary", "action": "send_notification", "params": {"title": "☀️ Daily Summary", "message": "Good morning! Here's your day ahead."}},
                },
            ],
            "edges": [
            ...
            "nodes": [
                {
                    ...
                    "type": "trigger",
                    "position": {"x": 250, "y": 0},
                    "data": {"label": "Event Starting Soon", "triggerType": "onServerEvent", "config": {"event": "calendar_event_upcoming"}},
                },
                {
                    "id": "action-1",
                    "type": "action",
                    "position": {"x": 250, "y": 150},
                    "data": {"label": "Send Reminder", "action": "send_notification", "params": {"title": "⏰ Event Reminder", "message": "Your event starts in 15 minutes!"}},
                },
            ],
            "edges": [
                {"id": "e1-2", "source": "trigger-1", "target": "action-1"},
            ...
            "nodes": [
                {
                    ...
                    "type": "trigger",
                    "position": {"x": 250, "y": 0},
                    "data": {"label": "Todo Added", "triggerType": "onDataChange", "config": {"data_source": "todos"}},
                },
                {
                    "id": "condition-1",
                    "type": "condition",
                ...
                },
                {
                    ...
                    "data": {"label": "Notify User", "action": "send_notification", "params": {"title": "📝 High Priority Task", "message": "New high-priority todo added: {{trigger.data.text}}"}},
                },
                {
                    "id": "action-2",
                    "type": "action",
                    "position": {"x": 400, "y": 300},
                    "data": {"label": "Log Event", "action": "log_event", "params": {"message": "Todo added: {{trigger.data.text}}"}},
                },
            ],
            "edges": [
