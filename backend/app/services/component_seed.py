...
INITIAL_COMPONENTS = [
    ...
    },
    {
        ...
        "icon": "📅",
        "description": "5-view calendar: Month, Week, Day, Event List, Compact. Self-contained — fetches its own data.",
        "props_schema": {
            "showTimeBlock": {"type": "boolean", "default": True},
            "variant": {"type": "enum", "options": ["month", "week", "day", "eventList", "compact"], "default": "month"},
            "sourceTypes": {"type": "string", "default": "local,caldav,notion,custom"},
            "categoryFilter": {"type": "string", "default": ""},
            "showSourceBadges": {"type": "boolean", "default": False},
            "showNotes": {"type": "boolean", "default": False},
            "compactThreshold": {"type": "number", "default": 200},
            "maxEvents": {"type": "number", "default": 10},
        },
        "default_props": {
            "showTimeBlock": True,
            "variant": "month",
            "sourceTypes": "local,caldav,notion,custom",
            "categoryFilter": "",
