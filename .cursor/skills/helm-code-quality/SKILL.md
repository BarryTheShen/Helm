...
description: Development rules and code quality standards for the Helm project. Points agents to AGENTS.md for the authoritative rules. Use when implementing, reviewing, or fixing code to ensure compliance with project standards.
---

# Helm Code Quality Standards

All code changes in the Helm project must comply with the rules defined in AGENTS.md. This skill summarizes key rules — but AGENTS.md is the source of truth.
