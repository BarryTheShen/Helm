...
All agents are at depth 1. Only the main Agent (or `helm-orchestrator` subagent) should invoke other subagents. Subagents cannot spawn further subagents.

```
Level 0: Main Agent / helm-orchestrator (delegates to subagents)
