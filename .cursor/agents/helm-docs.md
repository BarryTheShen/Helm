...
- Do NOT edit `.cursor/` agent or command files (unless explicitly asked)
...
## Edit policy
May edit: `docs/`, `README.md`, `AGENTS.md`, `CLAUDE.md` (thin compatibility wrapper only)
Must not edit: `backend/`, `mobile/`, `web/`, `agent/`, `.cursor/`
