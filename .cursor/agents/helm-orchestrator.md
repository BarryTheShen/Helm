...
| Config change (.cursor/, .env, etc.) | `helm-build` | General config edits |
...
- If the task reaches git stage, delegate to helm-git; ask Barry before push if the change is risky or scope is unclear.
